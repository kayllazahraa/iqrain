{{-- resources/views/livewire/admin/video/delete-video.blade.php --}}
<div>
    {{-- Tombol "Hapus" --}}
    <button 
    ...
    <x-dialog-modal wire:model="confirmDelete">
        ...
        <x-slot name="content">
            <div class="space-y-4">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Apakah Anda yakin ingin menghapus video pembelajaran ini? Tindakan ini tidak dapat dibatalkan.
                </p>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-red-700 dark:text-red-300">
                                <ul class="list-disc list-inside space-y-1">
                                    <li>File video dari server</li>
                                    <li>File subtitle (jika ada)</li>
                                    <li>Metadata video dari database</li>
                                    <li>Video tidak akan lagi tersedia untuk murid</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <dl class="space-y-2">
                        <div class="flex justify-between">
                            <dt class="font-medium text-sm text-gray-700 dark:text-gray-300">Judul Video:</dt>
                            <dd class="text-sm text-gray-900 dark:text-white font-semibold">
                                {{ $video->judul_video }}
                            </dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="font-medium text-sm text-gray-700 dark:text-gray-300">Tingkatan:</dt>
                            <dd class="text-sm text-gray-900 dark:text-white">
                                {{ $video->tingkatanIqra->nama_tingkatan }}
                            </dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="font-medium text-sm text-gray-700 dark:text-gray-300">Subtitle:</dt>
                            <dd class="text-sm text-gray-900 dark:text-white">
                                {{ $video->subtitle_path ? 'Ada' : 'Tidak ada' }}
                            </dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="font-medium text-sm text-gray-700 dark:text-gray-300">Ukuran File:</dt>
                            <dd class="text-sm text-gray-900 dark:text-white">
                                @if($video->video_path && Storage::disk('public')->exists($video->video_path))
                                    @php
                                        $bytes = Storage::disk('public')->size($video->video_path);
                                        $units = ['B', 'KB', 'MB', 'GB'];
                                        $i = 0;
                        ...
                        <div class="flex justify-between">
                            <dt class="font-medium text-sm text-gray-700 dark:text-gray-300">Ditambahkan:</dt>
                            <dd class="text-sm text-gray-900 dark:text-white">
        ...
        <x-slot name="footer">
            ...
            >
                ...
                <span wire:loading.remove wire:target="delete">Ya, Hapus Video</span>
