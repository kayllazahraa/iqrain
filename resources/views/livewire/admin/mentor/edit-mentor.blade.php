{{-- resources/views/livewire/admin/mentor/edit-mentor.blade.php --}}
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-3xl text-white font-bold">Edit Mentor</h1>
        </div>
        <p class="text-gray-400">Perbarui informasi mentor {{ $mentor->nama_lengkap }}</p>
    </div>
