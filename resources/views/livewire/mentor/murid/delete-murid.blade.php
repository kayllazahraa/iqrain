{{-- resources/views/livewire/mentor/murid/delete-murid.blade.php --}}
<div>
    {{-- Tombol "Hapus" --}}
    <button 
            ...
            <div class="space-y-4">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-red-700 dark:text-red-300">
                                <ul class="list-disc list-inside space-y-1">
                                    ...
                                    <li>Hasil game dan progress belajar</li>
                                    <li>Data leaderboard</li>
                                    <li>Preferensi pertanyaan keamanan</li>
                                    <li>Progress modul pembelajaran</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                    <dl class="space-y-2">
                        ...
                        <div class="flex justify-between">
                            <dt class="font-medium text-sm text-gray-700 dark:text-gray-300">Jumlah Game Dimainkan:</dt>
                            <dd class="text-sm text-gray-900 dark:text-white font-semibold">
                                {{ $murid->hasilGames()->count() }} kali
                            </dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="font-medium text-sm text-gray-700 dark:text-gray-300">Progress Modul:</dt>
                            <dd class="text-sm text-gray-900 dark:text-white font-semibold">
                                {{ $murid->progressModuls()->where('status', 'selesai')->count() }} / {{ $murid->progressModuls()->count() }} modul
                            </dd>
                        </div>
                    </dl>
                </div>
